...
-   Nie ma repozytorium, galezi, commita ani historii. Nie uruchamiamy `git`. Ostatni zamkniety pakiet: `PKG-0114`, 2026-08-24
...
-   ostatnie: `snapshots/PKG-0114-2026-08-24`
...
- Domknięcie pełnej pętli gry (Menu Główne, ekran pauzy, system punktów
  ...
  PKG-0114 techniczny P0 shellu i topologii jest zamknięty; kolejne bramki
  dotyczą R1 systemów, R2 content lock i R3/R4 buildów.
...
- zapis kampanii zachowuje `SAVE_SCHEMA_VERSION = 1`; ustawienia runtime mają
  osobny, wersjonowany plik JSON;
- nadal brak `export_presets.cfg`, buildów Windows/Linux i testu czystej
  instalacji;
- R1 pozostawia pełny remap, skalę tekstu, przełączalne PL/EN, rozszerzony pad
  i techniczną macierz dostępności.
...
`docs/NEXT_SESSION_PROMPT.md`. Nie wracaj do R0, nie eksportuj jeszcze buildów,
nie dodawaj nowych przeszkód i nie otwieraj zakresu web/mobile. R1 ma rozwinąć
istniejący shell bez naruszania trasy 01..41 → wybrany 42 → 43.
