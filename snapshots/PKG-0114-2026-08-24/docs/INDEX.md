...
| `VECTOR_STAGE_REPEATABILITY_AUDIT_H-005.md` | Plan i audyt powtarzalności kosztu Vector-Stage (PKG-0110) | pojawia sie wiarygodny budzet zrodlowy albo nowy dowod powtarzalnosci H-005 |
| `VECTOR_STAGE_BUDGET_PROVENANCE_AUDIT_H-005.md` | Audyt pochodzenia formalnego budżetu H-005 (PKG-0111) | pojawia sie uprzednie, wiarygodne zrodlo budzetu albo bezposredni dowod jego spelnienia |
| `IMPLEMENTATION_PLAN_AUDIT_AND_RELEASE_READINESS.md` | Macierz prawdy runtime, P0/P1 i droga R0..R5 do publicznego buildu PC (PKG-0113) | zmienia sie punkt wejscia, topologia kampanii, gotowosc buildu lub bramka wydania |
| `VECTOR_STAGE_ART_DIRECTION_AUDIT.md` | Audyt before/after wspolnej oprawy, CRT i menu pauzy (PKG-0113) | zmienia sie wspolne swiatlo, rama sceniczna, UI albo backlog content locku |
