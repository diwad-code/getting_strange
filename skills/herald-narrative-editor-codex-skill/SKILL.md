...
description: |
  HERALD Narrative Editor for Codex: skill do pisania, redagowania i wdrażania
  narracji, dialogów, inner voices, eventów JSON, ambientu i dokumentacji fabularnej
  gry HERALD. Używaj przy pracy w repo HERALD, szczególnie w web runtime
  TypeScript + PixiJS, gdy zadanie dotyczy fabuły, progresji, prologu, torporu,
  postaci, ECHO, Limes, Anny, czterech zakończeń, polskiej prozy SF albo
  player-facing copy.
