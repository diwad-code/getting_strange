...
##
## PRZESZKODA — dlaczego to tu jest: Komora UCP rozdziela trzy operacje, ponieważ
## odpowiedzialność za sprzeczną historię musi zostać załączona w jednym,
## jawnie obserwowalnym miejscu.
## PRZESZKODA — czego wymaga od Leny: Odczytania topografii świadków, porównania
## nazwanych kosztów i fizycznego załączenia jednej z konsol A/B/C, a następnie
## przejścia przez wrota wybranej operacji.
## PRZESZKODA — koszt porażki: Nie ma korekty fizycznej; dopóki żadna konsola nie
## zostanie załączona, wrota pozostają zamknięte, lecz wszystkie trzy operacje
## nadal są dostępne i nie powstaje test zręcznościowej poprawności.
##
## Audyt Aktu IV wybrał świadomą ciszę mechaniczną: scena nie dodaje geometrii
## fizycznej ani AnimatableBody2D tylko dla symetrii lub rytmu.
