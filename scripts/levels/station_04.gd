...
func _unlock_exit() -> void:
	...
	if exit_doors != null:
		ExitClearance.disable_collision(exit_doors)
...
func _draw_transit_carriage() -> void:
	...
	# PKG-0198 (ZERO wycinek 2): cień kontaktowy ławek wagonu w prawo, 0.48,
	# zgodnie z poręczą i konwencją 01/06/08.
	draw_colored_polygon(PackedVector2Array([
		Vector2(40.0, 308.0), Vector2(580.0, 298.0),
		Vector2(588.0, 306.0), Vector2(48.0, 316.0),
