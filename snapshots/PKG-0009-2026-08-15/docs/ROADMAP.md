...
Status: **DRAFT 0.1 UKONCZONY; H-002a REFUTED, REMEDIACJA PRZED P2**
...
- H-002a: audyt 43 przestrzeni zmierzyl **5 odrebnych zastosowan** (14, 20,
  22, 33, 41) przy progu 12; status **REFUTED**. Pelna metoda i tabela sa w
...
- policzono 5 odrębnych zastosowań Zakotwiczenia/Uległości, czyli wynik poniżej
  progu 12; H-002a ma status `REFUTED`;
...
Skutek dla kolejki: nie otwierać Prototype 02 na obecnym kontrakcie. Kolejny
pakiet musi najpierw przeprowadzić remediację zastosowań mechaniki do progu 12
bez dopisywania nowych mechanik i bez obniżania progu po cichu albo zapisać
jawną decyzję o zmianie kontraktu.
...
Status: **ZABLOKOWANY PRZEZ P1 I H-002a**

Przewidywany zakres:

- jeden typ obiektu w dwoch wersjach rzeczywistosci;
- jedno aktywne Zakotwiczenie;
- trzy pokoje: nauka, zastosowanie, komplikacja;
- jeden prosty proces korekty reagujacy na kotwice;
- bez finalnej grafiki, rozgalezionych zakonczen i systemu adaptacji.

Bramka P2 (przepisana, ADR-003):

Pomiar obiektywny:

- kazda mozliwa kotwica ma jednoznaczny, zrzutowalny stan przed i po;
- bledna proba zmienia obserwowalny stan swiata, a nie tylko cofa gracza -
  sprawdzane testem, nie odczuciem;
- trzy pokoje wykorzystuja trzy rozne klasy zastosowania kotwicy, potwierdzone
  testem automatycznym.

Audyt kontraktu:

- scenariusz musi osiagac prog H-002a; obecny wynik 5/43 jest sygnalem
  falsyfikujacym i wymaga remediacji albo jawnej decyzji STOP/PIVOT przed
  produkcja pokoi;
- zadne rozwiazanie pokoju nie wymaga wiedzy spoza gry.
...
Status: **ZABLOKOWANY PRZEZ P2**

Cel: 12-15 minut materialu o jakosci reprezentujacej produkt.

Wymagane elementy:

- zwyczajny proces i pierwsza mikroniezgodnosc;
