...
- iteracja anatomii i ruchu Leny na własnym model sheet;
- działająca pikselizacja świata, ostre teksty i omylne guidance;
...
rysy, a trasa, zapis, restart, tekst, guidance i ruch przechodzą testy.
