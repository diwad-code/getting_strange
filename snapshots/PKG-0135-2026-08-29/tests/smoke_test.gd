...
func _test_station_03() -> void:
	...
	_expect(station.is_level_completed, "station_03 must complete on entering return zone")
...
func _test_station_04() -> void:
	...
	_expect(station.is_level_completed, "station_04 must complete on entering return zone")
...
func _test_station_05() -> void:
	...
	_expect(station.is_level_completed, "station_05 must complete on entering return zone")
...
func _test_station_24() -> void:
	...
	_expect(airlock_zone != null, "station_24: airlock zone missing")
...
func _test_station_25() -> void:
	...
	_expect(airlock_zone != null, "station_25: airlock zone missing")
