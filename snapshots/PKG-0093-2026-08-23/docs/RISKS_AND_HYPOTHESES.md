...
| H-005 | Rówień Vector-Stage (własne płaszczyzny wielokątne i rytm poz) jest wykonalny w zakładanym zakresie | KOSZTOWA | TECHNICAL | PKG-0093: `VectorStageStyle`, `VectorStageEnvironment`, przerysowana sylwetka Leny i Station 01..05 przechodzą import/smoke; brak jeszcze budżetu 43 ręcznie skomponowanych kadrów | zmierzony koszt kadru i animacji mieści się w budżecie; **rozstrzygalne bez testerów** |
