...
func _draw() -> void:
	...
	draw_circle(Vector2(248, 214), 16, Color("d8a877"))
	draw_rect(Rect2(236, 230, 24, 38), Color("765259"))
	draw_circle(Vector2(348, 214), 16, Color("b99a85"))
	draw_rect(Rect2(336, 230, 24, 38), Color("586e79"))
	draw_circle(Vector2(478, 146), 18, Color("f0cc8d"))
	draw_rect(Rect2(466, 164, 24, 74), Color("5a3f40"))
