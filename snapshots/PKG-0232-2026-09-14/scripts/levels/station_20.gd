...
func _draw_state_layer() -> void:
	...
	# Wide-shot Marta: hair and septum carry her identity before dialogue begins.
	draw_circle(Vector2(260.0, 248.0), 7.0, Color("6d294f"))
	draw_circle(Vector2(260.0, 248.0), 4.5, witness_color)
	draw_line(Vector2(254.0, 243.0), Vector2(266.0, 241.5), Color("d45b9a"), 2.2)
	draw_line(Vector2(255.0, 248.0), Vector2(255.0, 259.0), Color("d45b9a"), 1.6)
	draw_line(Vector2(265.0, 248.0), Vector2(265.0, 259.0), Color("d45b9a"), 1.6)
	draw_arc(Vector2(261.5, 250.0), 1.25, 0.15, PI - 0.15, 5, Color("c7d3d6"), 0.8)
