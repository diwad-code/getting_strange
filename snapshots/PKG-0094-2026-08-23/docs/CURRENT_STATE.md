...
-   Nie ma repozytorium, galezi, commita ani historii. Nie uruchamiamy `git`. Ostatni zamkniety pakiet: `PKG-0094`, 2026-08-23
...
-   ostatnie: `snapshots/PKG-0094-2026-08-23`
...
`PKG-0095: Rówień Vector-Stage Aktu II i łańcuch przejść kampanii`

Cel: kontynuacja wyłącznie gry Godot (D-091..D-093) w następnym spójnym batchu:
1. ręcznie skonwertować Station 11..15 do Rówień Vector-Stage wraz z auditami,
   renderami i kontraktem testowym;
2. powiązać rzeczywiste zakończenia Station 01..15 z następną stacją przez API
   `GameStateManager`, zachowując tryb testowy i obecne collidery;
3. rozszerzyć checkpointy/cues kampanii na konwertowane stacje i sprawdzić
   deterministyczny łańcuch przejść;
4. uruchomić pełną weryfikację, udokumentować oraz zamrozić `PKG-0095`.
...
plik i `NEXT_SESSION_PROMPT.md`, a następnie przechodzi do realizacji PKG-0095 w silniku Godot 4.7.
