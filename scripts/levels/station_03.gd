...
func reply_to_marta() -> bool:
	...
	# CR-D (PKG-0196 §6): prośba z 01 nie wraca; Marta odpowiada domowym
	# konkretem, a Lena nie nazywa opóźnienia trzeci raz liczbą.
	if repeated_sample:
		_present([
...
func _draw_transit_stop() -> void:
	...
	# PKG-0198 (ZERO wycinek 2): cień kontaktowy wiaty i pojazdu w prawo,
	# 0.48, zgodnie z lampą poczekalni i konwencją 01/06/08.
	draw_colored_polygon(PackedVector2Array([
		Vector2(48.0, 302.0), Vector2(600.0, 292.0),
		Vector2(608.0, 300.0), Vector2(56.0, 310.0),
