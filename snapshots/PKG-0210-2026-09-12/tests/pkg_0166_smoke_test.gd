...
func _test_safe_rejections(state: Node) -> void:
	...
	_expect(station.commit_force_home(), "Zatwierdzenie metody z lukami musi pozostać możliwe")
	_expect(state.decisions.get(METHOD_FACT, "") == METHOD_FORCE_HOME, "Zatwierdzenie z lukami zapisuje metodę")
