...
# Tresc projektu: wylacznie gra Godot. Swiadomie pominiete: .agent, .codex,
# .claude, skills (tooling wylaczone z importu Godota), .godot, reports, logs
# (wyjscie generowane), snapshots (poprzednie kopie), archive_retired_web
# (martwy artefakt, D-098) oraz .git (nieuzywane od PKG-0006).
$include = @(
    'docs',
    'resources',
    'scenes',
