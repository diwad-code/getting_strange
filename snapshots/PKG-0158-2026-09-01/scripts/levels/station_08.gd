...
func _unlock_exit() -> void:
	...
	if apartment_door != null:
		ExitClearance.open_body_tweened(self, apartment_door, 116.0, 0.6)
...
func _draw() -> void:
	...
	# Lower wall: olive-grey oil lamperia (y=210..306)
	draw_rect(Rect2(0.0, 210.0, 640.0, 96.0), VectorStageStyle.shade(VectorStageStyle.MID_PLANE, 0.20))
	...
	draw_rect(Rect2(160.0, 140.0, 48.0, 166.0), VectorStageStyle.INK)
	draw_rect(Rect2(160.0, 140.0, 48.0, 166.0), door12_color, false, 1.5)
	draw_circle(Vector2(168.0, 230.0), 3.0, door12_color)
	# Stair landing & steps (x=260..380, step riser 14 px)
	draw_rect(Rect2(260.0, 292.0, 120.0, 14.0), VectorStageStyle.shade(VectorStageStyle.MID_PLANE, 0.35))
	draw_line(Vector2(260.0, 292.0), Vector2(380.0, 292.0), VectorStageStyle.LIGHT_PLANE, 1.5)
	draw_line(Vector2(260.0, 260.0), Vector2(380.0, 260.0), VectorStageStyle.shade(VectorStageStyle.LIGHT_PLANE, 0.30), 2.0)
	# Neighbour silhouette on landing (x=340)
	var neighbour_color := VectorStageStyle.ANCHOR_CYAN if is_neighbour_spoken_to else VectorStageStyle.HUMAN_AMBER
	draw_circle(Vector2(340.0, 205.0), 10.0, neighbour_color)
	draw_colored_polygon(PackedVector2Array([
		Vector2(330.0, 260.0), Vector2(350.0, 260.0), Vector2(348.0, 220.0), Vector2(332.0, 220.0),
	]), neighbour_color)
	# Potted fern planter on landing
	draw_rect(Rect2(365.0, 276.0, 14.0, 16.0), VectorStageStyle.shade(VectorStageStyle.MID_PLANE, 0.50))
	draw_circle(Vector2(372.0, 272.0), 6.0, VectorStageStyle.ANCHOR_CYAN)
	...
	draw_rect(Rect2(540.0, 130.0, 60.0, 176.0), VectorStageStyle.INK)
	draw_rect(Rect2(540.0, 130.0, 60.0, 176.0), door14_color, false, 2.0)
