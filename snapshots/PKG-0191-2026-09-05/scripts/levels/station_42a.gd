...
const DIALOGUE_LINES: Array[Dictionary] = [
	{"speaker": "LENA", "text": "Ten sam stół. Świt. Jedno miejsce puste."},
	{"speaker": "MARTA", "text": "Wróciłaś. Kogo zostawiłaś po drugiej stronie?"},
	{"speaker": "LENA", "text": "Ją. Między adresami."},
	{"speaker": "JAKUB", "text": "Pamiętaj osobno. Obie."},
]
...
func _setup_guidance() -> void:
	...
	_register_beat(&"s42a_sealed_seen", GuidanceBeat.Tier.L1_REACTION, &"observation", &"factual", "Ona zostaje między adresami. To skutek, nie ocena.", "She stays between addresses. That is a consequence, not a verdict.", &"", "")
