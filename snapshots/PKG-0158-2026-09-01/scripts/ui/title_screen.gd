...
func _build_interface() -> void:
	...
	_controls_label = _add_label(_title_panel, "ControlsHint", "", Vector2(306.0, 176.0), Vector2(230.0, 36.0), 9, VectorStageStyle.shade(VectorStageStyle.LIGHT_PLANE, 0.12))
...
func _refresh_state() -> void:
	...
	_controls_label.text = "%s\n%s  ·  %s" % [
		_tr("CONTROLS_HEADER"),
		_action_prompt(&"move_left", _tr("INPUT_ACTION_MOVE_LEFT")),
