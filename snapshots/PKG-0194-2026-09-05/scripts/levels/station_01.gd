...
func _draw() -> void:
	...
	draw_line(Vector2(247.0, 204.0), Vector2(247.0, 248.0), VectorStageStyle.LIGHT_PLANE, 1.0)
	draw_line(Vector2(223.0, 226.0), Vector2(271.0, 226.0), VectorStageStyle.LIGHT_PLANE, 1.0)
	for x in [96.0, 126.0]:
