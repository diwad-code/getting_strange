...
- **Mega-Pakiet Wysokoprzepustowy (High-Throughput Mega-Package, D-085)**: Tryb domyślny dla autonomicznego AI (Lead Programmer & Art Director). Obejmuje 2x do 5x większy zakres funkcjonalny realizowany całościowo w jednym cyklu:
  - Zamiast pojedynczych mikro-kroków, pakiet łączy równolegle 3–5 kompletnych podsystemów (np. konwersja kadrów Rówień Vector-Stage + rozszerzenie łańcucha kampanii + kontrakt testowy + rendery kontrolne + audyt biblii wizualnej).
