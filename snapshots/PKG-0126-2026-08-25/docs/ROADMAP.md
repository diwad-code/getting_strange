...
Pakiety: **PKG-0124 (Release Candidate 1), PKG-0125 (Lena 3.0, Wspinaczka, Dwukierunkowość), PKG-0126 (Szlif atmosferyczny, Soundscapes, Cząsteczki, CRT Pacing)**  
Status: **ZAKOŃCZONE SUKCESEM (RC1 + MECHANICZNA GŁĘBIA 3.0 + KINOWA ATMOSFERA)**
...
13. Ścisłe zachowanie zakazu generowania plików `.exe` i paczek binarnych po pakiecie (weryfikacja bramką `pkg_0126_smoke_test.gd`).
