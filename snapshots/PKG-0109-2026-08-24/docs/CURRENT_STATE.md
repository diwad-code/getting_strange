...
-   Nie ma repozytorium, galezi, commita ani historii. Nie uruchamiamy `git`. Ostatni zamkniety pakiet: `PKG-0109`, 2026-08-24
...
-   ostatnie: `snapshots/PKG-0109-2026-08-24`
...
`PKG-0110: H-005 — kontrakt budżetu i powtarzalność pomiaru`
...
wyłącznie aktualny prompt PKG-0110 w Godot 4.7. Obowiązują D-096, D-099,
...
nie istnieje jawny budżet produkcyjny i pomiar jego spełnienia; nie wolno
traktować `16.667 ms` jako budżetu ustanowionego przez sam wymóg 60 FPS.
