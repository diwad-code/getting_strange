...
## PKG-0141 (D-151). Wstrzas jest zawsze akcentem, nigdy jedynym nosnikiem
## informacji, wiec tryb ograniczonego ruchu zdejmuje go w calosci — i to juz
## na wejsciu, zeby zadna stacja nie musiala pytac o tryb przed wolaniem.
func add_trauma(amount: float) -> void:
	if not MotionAccessibility.allows_camera_shake():
