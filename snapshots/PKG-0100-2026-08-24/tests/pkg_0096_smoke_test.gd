...
func _run() -> void:
	...
	if state:
		...
		# PKG-0097 extended the delivered chain to Station 25; Station 20 now unlocks Station 21.
		_expect(state.has_reached_station(&"station_21"), "completing station 20 must unlock station 21 (limit 25)")
		_expect(
