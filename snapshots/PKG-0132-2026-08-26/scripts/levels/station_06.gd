...
func _setup_guidance() -> void:
	...
	beat_intent.text_pl = "Sprawdzę numer wersji na papierze."
...
func open_bus_doors() -> void:
	...
	if replacement_bus_exit_door:
		...
		tween.tween_property(replacement_bus_exit_door, "position:y", 60.0, 0.8).set_trans(Tween.TRANS_QUAD).set_ease(Tween.EASE_OUT)
