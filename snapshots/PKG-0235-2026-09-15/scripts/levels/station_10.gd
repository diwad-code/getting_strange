...
func _setup_guidance() -> void:
	...
	_register_beat(&"s10_exit_ucp_record", GuidanceBeat.Tier.L3_DIRECTIONAL_THOUGHT, &"intention", &"procedural", "Marta twierdzi, że pracuję w UCP. Sprawdzę zapis, zanim uznam to za moje.", "Marta claims I work at UCP. I will check the record before I take it as mine.", &"", "")
