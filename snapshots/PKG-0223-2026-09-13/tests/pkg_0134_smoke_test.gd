...
func _test_door_clearance() -> void:
	...
	if station.has_method("inspect_detour_closure"):
		station.call("inspect_detour_closure")
	if station.has_method("compare_detour_time"):
		station.call("compare_detour_time")
	if station.has_method("take_service_ladder"):
		station.call("take_service_ladder")
