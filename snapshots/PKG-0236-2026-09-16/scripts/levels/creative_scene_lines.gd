...
const LINES := {
	...
	"cost_ledger_console": [["REJESTR UCP", "Rejestr 04/17: dwa końce pary — stabilna Równia i pogrzeb Jakuba. Wpisane jedną ręką."], ["REJESTR UCP", "Drugi koniec pary: śmierć Jakuba tam, gdzie ja go pochowałam."], ["Lena", "Ktoś utrzymuje zapis. Ktoś drugi zapłacił. Korelacja to nie dowód powiązanego kosztu."]],
	"adaptation_offer_terminal": [["WIERZBICKA", "Stan: wpis w zakresie miejscowej. Stabilność: dom, Marta, żywy Jakub."], ["Lena", "Bez kosztu? Bez cudzej pamięci w mojej głowie?"], ["WIERZBICKA", "Procedura zachowuje rolę w dopuszczalnym odchyleniu. Wspomnienia zostałyby wygładzone."], ["Lena", "Odmawiam. Nie będę wygodnym zastępstwem."]],
