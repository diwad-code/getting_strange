...
const LINES := {
	...
	"household_b_full": [["Lena", "Jestem na wiacie z linii 03. Czytnik nie ma tu adresu."], ["EKRAN CZYTNIKA", "Wysłana wiadomość: Jadę. Adresat: brak w sieci."], ["WIADOMOŚĆ DOMOWA", "Marta zostawiła drugie zgłoszenie. Numeru zwrotnego nie dopisała."], ["ZAPIS SERWISOWY", "Jakub oddał napęd przed końcem zmiany. Dalej pracuje w swoim zakresie."], ["ZAPIS UCP", "Eksport kosztów z tego węzła zamknięty."]],
	"household_b_partial": [["Lena", "Jestem na wiacie z linii 03. Czytnik nie ma tu adresu."], ["EKRAN CZYTNIKA", "Wysłana wiadomość: Jadę. Adresat: brak w sieci."], ["WIADOMOŚĆ DOMOWA", "Marta zostawiła zgłoszenie bez szczegółu próby."], ["ZAPIS SERWISOWY", "Jakub oddał napęd przed końcem zmiany. Dalej pracuje w swoim zakresie."], ["ZAPIS UCP", "Eksport kosztów z tego węzła zamknięty."]],
	"household_b_withheld": [["Lena", "Jestem na wiacie z linii 03. Czytnik nie ma tu adresu."], ["EKRAN CZYTNIKA", "Wysłana wiadomość: Jadę. Adresat: brak w sieci."], ["WIADOMOŚĆ DOMOWA", "Marta zostawiła zgłoszenie z samym imieniem."], ["ZAPIS SERWISOWY", "Jakub oddał napęd przed końcem zmiany. Dalej pracuje w swoim zakresie."], ["ZAPIS UCP", "Eksport kosztów z tego węzła zamknięty."]],
