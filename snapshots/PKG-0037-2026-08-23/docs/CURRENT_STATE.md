...
-   Nie ma repozytorium, galezi, commita ani historii. Nie uruchamiamy `git`. Ostatni zamkniety pakiet: `PKG-0093`, 2026-08-23
...
-   ostatnie: `snapshots/PKG-0093-2026-08-23`
...
`PKG-0094: Konwersja Rówień Vector-Stage Aktu I i Pętla Kampanii`

Cel: kontynuacja wyłącznie gry Godot (D-091, D-092) — jednocześnie wdrożyć
używalną pętlę kampanii i konwertować grafikę według obowiązującej biblii:
1. Dodać wersjonowany zapis `user://`, bezpieczne odtworzenie GameStateManager i restart checkpointu.
2. Dostarczyć menu pauzy i wyboru 43 poziomów z przejściem fade-to-black.
3. Ręcznie skonwertować Station 06..10 do Rówień Vector-Stage; każdy kadr ma
   własną oś, warstwy, limit palety, render i test.
4. Zintegrować checkpointy, poszlaki, decyzje i kluczowe CRT dialogue cues z istniejącymi stacjami.
5. Uruchomić pełną weryfikację, zaktualizować dokumentację i zamrozić `PKG-0094`.
...
plik i `NEXT_SESSION_PROMPT.md`, a następnie przechodzi do realizacji PKG-0094 w silniku Godot 4.7.
