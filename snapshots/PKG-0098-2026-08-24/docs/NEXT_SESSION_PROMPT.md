# Prompt dla następnej sesji: PKG-0099 (Widoczność Rówień w Station 01..20 i Akt IId 26..30)

## CEL SESJI

Zgodnie z decyzjami **D-092..D-098** — 100% prac na grze Godot 4.7 (`Getting Strange`).
PKG-0097 dostarczył ręczny Rówień Vector-Stage dla Station 21..25,
...
5. **Weryfikacja**: dodać bramkę PKG-0099 do `tools/verify.ps1`, uruchomić capture
...
- Rola AI: Pełna autonomia jako **Lead Programmer** oraz **Art Director** (D-025, D-085, D-089, ADR-004) — praca wyłącznie nad silnikiem gry Godot (D-098).
...
5. Zaktualizować dokumentację i zamrozić PKG-0099.

## KONIEC PAKIETU JEST OBOWIAZKOWY

Pakiet PKG-0099 musi zostać zweryfikowany przez `tools/verify.ps1`, opisany w dokumentacji projektu i zamrożony poleceniem:
`pwsh -NoProfile -File .\tools\snapshot.ps1 -Package PKG-0099`.
