...
function downloadReleasePackage(type) {
  ...
  if (type === "web") {
    ...
    content = JSON.stringify({
      ...
      version: "1.0.0-vertical-slice-pkg0069",
    ...
    filename = "getting_strange_telemetry_pkg0070.log";
    content = `=======================================================
GETTING STRANGE TELEMETRY REPORT — PKG-0070
=======================================================
...
Playable Simulation Chambers: 01..10 (incl. Reaktor Centralny & Zero Point) [PASS]
...
class IKPRetroTerminal {
  ...
  init() {
    ...
    this.output = this.container.querySelector(".retro-terminal-output");
    this.input = this.container.querySelector(".retro-terminal-input");
  ...
  executeCommand(rawCmd) {
    ...
    switch (cmd) {
      case "help":
        ...
        this.printLine("  status               — Status telemetrii i weryfikacji nośnej 740 Hz (PKG-0088).");
        ...
        this.printLine("  export-telemetry     — Eksportuje kompletny dziennik telemetrii PKG-0088 JSON.");
        this.printLine("  clear                — Czyści ekran konsoli.");
        this.printLine("  export-all           — Generuje kompletny manifest dystrybucyjny.");
        break;

      case "status":
        this.printLine("/// TELEMETRIA INSTYTUTU CIĄGŁOŚCI PRZESTRZENNEJ (PKG-0088) ///", "accent-cyan");
