...
`PKG-0099: Naprawa widoczności Rówień Vector-Stage w Station 01..20 i konwersja Aktu IId 26..30`
...
5. uruchomić pełną weryfikację, udokumentować oraz zamrozić `PKG-0099`.
...
plik i `NEXT_SESSION_PROMPT.md`, a następnie przechodzi do realizacji PKG-0099 w silniku Godot 4.7.
