...
| Lena stojąca (29 lat, ~168 cm) | **87 ± 3 px** od stopy do czubka włosów | nie collider |
...
## 7. Egzekwowanie kanonu (D-191, 2026-09-02)

Kanon skali obowiązuje od PKG-0131. Pomiar runtime z 2026-09-02 pokazał, że
**nie był egzekwowany**: siedem z ośmiu przęseł drzwiowych na trasie 20 adresów
łamie tabelę z rozdziału 3, a wszystkie postacie poza Leną są 2–4× za małe.

### 7.1 Zmierzone naruszenia — stan przed PHASE-08

**Drzwi — collidery w `.tscn`:**

| Adres | Jest | Przelicznik | Werdykt |
|---|---|---|---|
| station_01 | 20 × 180 | 0,38 × 3,46 m | FAIL |
| station_02 | 18 × 116 | 0,35 × 2,23 m | FAIL (szerokość) |
| station_03 | 18 × 116 | 0,35 × 2,23 m | FAIL (szerokość) |
| station_04 | 20 × 172 | 0,38 × 3,31 m | FAIL |
| station_07 | 24 × 170 | 0,46 × 3,27 m | FAIL |
| station_08 | 24 × 170 | 0,46 × 3,27 m | FAIL |
| station_10 | 52 × 108 | 1,00 × 2,08 m | **PASS — wzorzec** |
| station_12 | 24 × 132 | 0,46 × 2,54 m | FAIL |

**Drzwi — rysunki w `_draw()`:** `station_07.gd:280` 56 × 146;
`station_08.gd:261` 48 × 156; `station_08.gd:287` 60 × **176** (3,38 m — to
jest przęsło, które właściciel nazwał „drzwiami na 4 metry”);
`station_02.gd` 20 × 118.

**Postacie:** figury rysowane w `memory_resonance_point.gd` mają
Jakub ≈36 px (0,69 m), Marta ≈48 px, Szymon ≈30 px, Wierzbicka ≈22 px.
Tabela rozdziału 3 wymaga 84–92 px.

**Drabina:** Station 02 ma rysunek przesunięty o 62 px względem funkcjonalnej
`LadderZone` — rozdział 3 nie miał dotąd wiersza o zgodności rysunku ze strefą.

### 7.2 Uzupełnienie tabeli rozdziału 3

| Obiekt | Wysokość | Szerokość | Uwaga |
|---|---:|---:|---|
| Drzwi wagonu tramwaju | 100–110 | 52–64 | otwór dwuskrzydłowy, rozsuwany |
| Właz techniczny | 56–70 | 56–70 | przejście na czworaka |
| Brama / wjazd | 130–150 | 120–200 | wyłącznie tam, gdzie wjeżdża pojazd |

### 7.3 Zasada jednego źródła

Po PHASE-08 rysunek otworu i collider otworu pochodzą z jednego pola —
`ThresholdZone.aperture_rect` (`docs/rebuild/THRESHOLD_AND_ENTRY_CONTRACT.md` §7.3).
Rozjazd między warstwą rysowaną a fizyczną przestaje być możliwy z konstrukcji,
a nie z dyscypliny.

### 7.4 Lint zamiast dobrych chęci

Ręczny „test dwóch klatek" z rozdziału 4 zostaje, ale przestaje być jedynym
mechanizmem. Powstaje automatyczny lint geometrii (część GATE-SCALE), który
zgłasza błąd, gdy:

- otwór wychodzi poza tabelę rozdziału 3 lub 7.2 o więcej niż **10%**;
- rysunek otworu różni się od collidera o więcej niż **2 px**;
- rysunek drabiny różni się od `LadderZone` o więcej niż 2 px w pionie
  albo 1 px w osi x;
- podstopnica przekracza 18 px albo różni się między stopniami tej samej
  klatki schodowej;
- postać w scenie ma wysokość poza przedziałem **84–92 px** (poza jawnymi
  wyjątkami z `CAST_AND_NPC_BIBLE.md` §1: sylwetka wewnątrz rekwizytu i celowo
  nieczytelny cień za matową szybą).

Lint dowodzi zgodności z tabelą. Nie dowodzi urody ani czytelności.
