...
func _run() -> void:
	...
	print("1. ObjectDB and signal hygiene...")
	await _test_objectdb_and_signal_hygiene()
	print("2. Kinematics step-down...")
	await _test_kinematics_step_down()
	print("3. Portrait contracts...")
	_test_portrait_contracts()
	print("4. Narrative dialogue remediation...")
	_test_narrative_dialogue_remediation()
	print("5. Sensory innovations...")
	await _test_sensory_innovations()
	print("6. D-168 no unexpected .exe...")
