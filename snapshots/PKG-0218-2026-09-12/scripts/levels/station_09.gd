...
func _draw() -> void:
	...
	draw_colored_polygon(PackedVector2Array([Vector2(230.0, 156.0), Vector2(188.0, 250.0), Vector2(272.0, 250.0)]), Color(VectorStageStyle.HUMAN_AMBER, 0.14))
	draw_rect(Rect2(224.0, 164.0, 12.0, 34.0), wood_dark)
	draw_circle(Vector2(230.0, 156.0), 14.0, VectorStageStyle.HUMAN_AMBER)
