...
-   Nie ma repozytorium, galezi, commita ani historii. Nie uruchamiamy `git`. Ostatni zamkniety pakiet: `PKG-0097`, 2026-08-24
...
-   ostatnie: `snapshots/PKG-0097-2026-08-24`
...
- **Dług techniczny (D-096): Station 01..20 mają zasłonięty Rówień Vector-Stage.**
  ...
  w Station 21..25 (`_draw_state_layer()`); przeniesienie go na 01..20 jest zakresem PKG-0098.

## Nastepny pakiet

`PKG-0098: Naprawa widoczności Rówień Vector-Stage w Station 01..20 i konwersja Aktu IId 26..30`

Cel: kontynuacja wyłącznie gry Godot (D-091..D-097):
1. przenieść wzorzec D-096 (`_draw_state_layer()`) na Station 01..20, tak aby
   warstwa Vector-Stage była realnie widoczna, bez zmiany colliderów i geometrii;
2. rozszerzyć smoke PKG-0094/0095/0096 o kontrolę widoczności kadru, nie tylko
   obecności węzła, oraz odnowić rendery Aktów I/II/IIb;
3. ręcznie skonwertować Station 26..30 do Rówień Vector-Stage wraz z audytem;
4. rozszerzyć limit łańcucha ukończeń do Station 30 dopiero razem z testem;
5. uruchomić pełną weryfikację, udokumentować oraz zamrozić `PKG-0098`.
...
plik i `NEXT_SESSION_PROMPT.md`, a następnie przechodzi do realizacji PKG-0098 w silniku Godot 4.7.
