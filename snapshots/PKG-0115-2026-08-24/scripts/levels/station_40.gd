...
## PRZESZKODA — dlaczego to tu jest: Sala Negocjacyjna istnieje, aby świadkowie
## mogli nazwać koszty trzech operacji przed ich wykonaniem.
## PRZESZKODA — czego wymaga od Leny: Wysłuchania Wierzbickiej, Marty, Jakuba i
## Szymona oraz wejścia do Komory Wyboru dopiero po rozpoznaniu znanych kosztów.
## PRZESZKODA — koszt porażki: Nie ma korekty fizycznej; decyzja może być trudna
## i nieodwracalna fabularnie, ale przejście do Station 41 nie jest testem
## zręcznościowym.
