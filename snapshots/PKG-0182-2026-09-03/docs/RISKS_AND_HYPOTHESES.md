...
| H-045 | Obsada zbudowana jednym rigiem w skali 84–92 px czyta się jako ci sami ludzie w świecie i na portrecie | MIERZALNA + ODBIORCZA | TECHNICAL (GATE-CAST PKG-0172) / OPEN-NO-EVIDENCE (odbiór) | PKG-0172: `CharacterVisualRig` 64×104, pivot (32, 96), Marta/Jakub/Wierzbicka na trasie, 0 figur prymitywnych na 20 adresach, portret Marty nie jest przeróbką Leny. Testy i kadry nie dowodzą, że Marta „wygląda dobrze” — to ocena właściciela (D-012, ADR-003). |
