...
## PKG-0234 (A1): StairwellPlanter zostaje w drzewie (piny 0100/0119/0135),
## ale nie jest cialem na drodze — doniczka na komodzie, collider wylaczony.
## Kampania otwiera prog wylacznie private_boundary, nie is_passage_clear.
...
var is_private_boundary_respected := false
...
func _physics_process(_delta: float) -> void:
	# PKG-0234 (A1): auto-push zdjety z trasy kampanii. Callable push_planter
	# nadal rusza wezel dla testow 0119/smoke; is_passage_clear nie otwiera progu.
...
func respect_private_boundary() -> bool:
	...
	is_private_boundary_respected = true
	_unlock_exit()
	queue_redraw()
	return true
