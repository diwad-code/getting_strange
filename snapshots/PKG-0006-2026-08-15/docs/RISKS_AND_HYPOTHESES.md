...
| H-010a | Zwrot o skorygowanej galezi Leny ma co najmniej trzy zapowiedzi obecne w tekscie i dostrzegalne przy pierwszym odbiorze | MIERZALNA | **REFUTED (2026-08-15)** | audyt tekstu: `CONTINUITY_TRACKER.md` R-04 deklaruje szesc poszlak; dwie (pusty margines fotografii w scenie 01, nazwisko po obu stronach listy w scenie 30) nie wystepuja w `FULL_STORY.md`; jedna (scena 17) dotyczy systemu, nie galezi Leny. Realnie: dwie | ponowny pomiar po wykonaniu poprawki P0-4; do tego czasu tracker nie moze deklarowac trzech poszlak |
...
- MIERZALNE: H-002a, H-009a, H-010a, H-011a, H-012 - piec, z czego dwie juz
  rozstrzygniete i obie negatywnie;
