...
Status: **W TOKU** (jedyny tor produkcyjny: **gra Godot 4.7**. Portal Web jest zamrożony i nie rozwijany — D-090 uchylona jako błąd interpretacji, D-091 kieruje 100% prac na ukończenie gry. Nie ma żadnych prac nad stroną, symulatorami webowymi ani portalami dystrybucyjnymi)
...
2. **Oprawa Wizualna Poziomów i Oświetlenie 2D (Station 01..43)**:
   - Od PKG-0093 kanoniczną techniką jest własny `Rówień Vector-Stage`, nie
     pixel art: duże płaszczyzny, ograniczona paleta, twarde krawędzie,
     asymetryczne sylwetki i sceniczne kadrowanie; zob. `VISUAL_DESIGN.md`.
