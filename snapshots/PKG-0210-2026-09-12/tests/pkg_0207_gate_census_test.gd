...
##
## PKG-0208 (D-223) & PKG-0210 (D-224): kontrolowana aktualizacja liczb
## 104 -> 105 / 103 -> 104 / 102 -> 103 / 102 -> 103 razem z bramka audytu Aurelius
## (jawna regula ewolucji z D-222, wzor D-216/D-218/D-223).
...
const EXPECTED_INVOKE_LINES := 105
const EXPECTED_SCRIPT_ARGS := 104
const EXPECTED_TEST_REFS := 103
const EXPECTED_DISK_TESTS := 103
