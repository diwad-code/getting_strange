...
func _setup_guidance() -> void:
	...
	beat_catwalk.text_pl = "Ścieżka serwisowa jest wolna. Wyjście za komorą."
...
func unlock_exit_door() -> void:
	...
	if chamber_door:
		tween.tween_property(chamber_door, "position:y", chamber_door.position.y - 70.0, 1.0).set_trans(Tween.TRANS_QUAD).set_ease(Tween.EASE_OUT)
