...
Audyt PKG-0099 wykazał, że **38 z 43 przestrzeni ma dokładnie cztery collidery**
— podłogę, sufit i dwie ściany. Gracz wchodzi z lewej, idzie w prawo, dotyka
rekwizytów i wychodzi. Centralna mechanika (Zakotwiczenie / Uległość) istnieje
wyłącznie w prototypie `anchor_lab` i nie występuje w żadnej z 43 przestrzeni
kampanii. Pętla 30-sekundowa obiecana w `PRODUCT_BRIEF.md` nie jest
zaimplementowana nigdzie.
...
- **Dług znany:** w Station 01..20 warstwa Vector-Stage jest zasłonięta przez
  nieprzezroczyste tło rysowane przez skrypt stacji (D-096).
