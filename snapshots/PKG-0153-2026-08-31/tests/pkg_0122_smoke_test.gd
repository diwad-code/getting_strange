...
## PKG-0122 Smoke Test — Station 31..37, Sekwencje S11/S12/S13 (Podstruktura, Magazyn Dowodów i rejestr par) według P7
...
func _run_all_tests() -> void:
	print("== PKG-0122 Station 31-37 Canon 0.3 / P7 Gate ==")
...
func _test_station_31() -> void:
	...
	_expect(inst.is_adaptation_rejected, "Station 31: Oferta adaptacji musi być odrzucona")
...
func _test_station_32() -> void:
	...
	_expect(inst.is_material_memory_anchored, "Station 32: Pamięć materiału musi być zakotwiczona")
...
func _test_station_33() -> void:
	...
	inst.reconstruct_local_lena_intent()
	...
	_expect(inst.is_local_lena_intent_found, "Station 33: Intencja miejscowej Leny musi być zrekonstruowana")
...
func _test_station_34() -> void:
	...
	_expect(inst.is_pair_registry_unlocked, "Station 34: Rejestr par musi być odblokowany")
...
func _test_station_35() -> void:
	...
	_expect(inst.is_home_echo_verified, "Station 35: Echo domu musi być zweryfikowane")
...
func _test_station_36() -> void:
	...
	_expect(inst.is_ucp_cost_ledger_found, "Station 36: Rejestr kosztu UCP musi być odkryty")
...
func _test_station_37() -> void:
	...
	_expect(inst.is_living_signal_bridged, "Station 37: Żywy sygnał musi być spięty")
