...
func _setup_audio() -> void:
	...
	_subway_hum_sound = ProceduralAudio.create_subway_hum_sound()
	_neon_sound = ProceduralAudio.create_neon_flicker_sound()
	...
	_shadow_whisper_sound = ProceduralAudio.create_shadow_whisper_sound()
	...
	_catwalk_footstep_sound = ProceduralAudio.create_catwalk_footstep_sound()
	...
	_tea_pour_sound = ProceduralAudio.create_tea_pour_steam_sound()
