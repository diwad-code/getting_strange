...
| H-027 | Lena 4.0 (sprite `gen-ai`) czyta się jako dorosła kobieta w skali mebli | MIERZALNA + ODBIORCZA | TECHNICAL (87 px + sprite) / OPEN-NO-EVIDENCE (odbiór) | Idle 46×87, kapsuła 72, biurko 01 = 39 px. Capture okiem na normalnym driverze: PKG-0133. ADR-003. |
