...
Status: **W TOKU (Otwarcie: PKG-0019, postęp: Station 01..37 wdrożone — Akt I oraz Akt II w pełni domknięte w silniku, Akt III: Podstruktura rozwinięty; Komora Sygnałowa / Węzeł Nadawczy: centralny podziemny węzeł transmisyjny na poziomie -40 m, oscyloskop CRT obrazujący rezonans fal Leny i Śladu, krosownica transmisyjna sektorów 1..4 z liniami Marty, Szymona i ofiar Linii 4, pionowa antena emisyjna z cewkami toroidalnymi, pulpit injekcyjny z heblami wzmacniającymi emisję do miejskich odbiorników oraz śluza transmisyjna ku Przestrzeni 38 / Człowiek zamiast dowodu)**
