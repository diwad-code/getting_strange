...
-   Nie ma repozytorium, galezi, commita ani historii. Nie uruchamiamy `git`. Ostatni zamkniety pakiet: `PKG-0106`, 2026-08-24
...
-   ostatnie: `snapshots/PKG-0106-2026-08-24`
...
`PKG-0108: H-012 — techniczny audyt czytelności Rówień Vector-Stage`
...
wyłącznie aktualny prompt PKG-0108 w Godot 4.7. Obowiązują D-096, D-099,
D-103, D-104, D-105, D-106, D-107, D-108, niezmienny limit 25, brak Git oraz
brak jakiejkolwiek powierzchni webowej. H-012 wolno zmienić z `UNTESTED`
wyłącznie po zapisaniu obiektywnego pomiaru spełniającego jego kontrakt;
same renderingi i automaty nie są dowodem odbioru.
