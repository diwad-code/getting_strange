...
-   Nie ma repozytorium, galezi, commita ani historii. Nie uruchamiamy `git`. Ostatni zamkniety pakiet: `PKG-0111`, 2026-08-24
...
-   ostatnie: `snapshots/PKG-0111-2026-08-24`
...
`PKG-0112: H-005 — kontrolowane przyjęcie źródła budżetu`
...
wyłącznie aktualny prompt PKG-0112 w Godot 4.7. Obowiązują D-096, D-099,
...
sam wymóg 60 FPS. PKG-0112 nie zmienia produktu; może uznać nowy, uprzedni
artefakt tylko wtedy, gdy ma źródło, datę, zakres, limit/model i metodę
