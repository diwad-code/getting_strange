...
func _test_bundle_06_shell_promise() -> void:
	...
	var controls_label := title.get_node_or_null("TitlePanel/ControlsHint") as Label
	...
	_expect(controls_label != null and controls_label.text.contains("RUSZ SIĘ / ZBADAJ"), "Controls header must be concise")
...
func _test_bundle_08_station_02_detour() -> void:
	...
	_expect(ladder != null and ladder.ladder_height >= 80.0, "ServiceLadder height must bridge the embankment")
