...
## PKG-0225 — capture station_05 / station_18 / station_42a / station_42b /
## station_42c at 100% x full/notext (normal Windows driver; headless hangs on
## frame_post_draw, fact from PKG-0197). Tag via env PKG0225_TAG (pre/post),
## output 10 PNG 640x360 + frames.tsv under reports/pkg_0225/visual.
## No overwrites of 0187..0224 archives. Frames prove HOLD of the street rhyme
## (K6), finale carriers (K1/K2/K3/K5) and vignette trigger states.

const OUT_DIR := "res://reports/pkg_0225/visual"
const CORE_IDS: Array[String] = ["station_05", "station_18", "station_42a", "station_42b", "station_42c"]
...
func _run() -> void:
	...
	var tag := OS.get_environment("PKG0225_TAG")
	if tag == "":
		tag = "pre"
