...
func _test_station_42a_flow(state: Object) -> void:
	...
	_expect(st.has_method("inspect_cups"), "Station 42A has inspect_cups")
	_expect(st.has_method("witness_chamber_a"), "Station 42A has witness_chamber_a")
...
func _test_station_42b_flow(state: Object) -> void:
	...
	_expect(st.has_method("inspect_doorstep"), "Station 42B has inspect_doorstep")
	_expect(st.has_method("witness_chamber_b"), "Station 42B has witness_chamber_b")
...
func _test_station_42c_flow(state: Object) -> void:
	...
	_expect(st.has_method("inspect_tram"), "Station 42C has inspect_tram")
	_expect(st.has_method("witness_chamber_c"), "Station 42C has witness_chamber_c")
