...
##
## PKG-0197 (ZERO REWIZJA, D-214): wszystkie podpisy drugiej klatki wyzerowane.
## Diagnoza: 6 z 7 winiet dubbingowało scenę tezą autorską w głosie Leny, innym
## językiem obrazu niż scena (plansza gen-ai + sentencja). Wzmacnia tylko
## czysty obraz bez podpisu (wzór: vig_synthesis). Fakty niosą już stacje;
## winieta jest wzmocnieniem, nigdy jedynym nośnikiem. Sloty i wyzwalacze
## bez zmian; treść scen nietknięta.
##
