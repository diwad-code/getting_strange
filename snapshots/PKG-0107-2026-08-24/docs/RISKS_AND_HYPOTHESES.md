...
| H-012 | Materialna, nieglitchowa korekta jest czytelna w 640x360 | MIERZALNA | UNTESTED | render przez `tools/capture_preview.gd`, pomiar wielkosci elementu w pikselach, kontrast, zachowanie przy skalowaniu calkowitym 1x-4x, symulacja deuteranopii i protanopii | PKG-0107 obejrzał cztery świeże kadry Station 42A, 42B, 42C i 43 z logicznej przestrzeni 640x360 i potwierdził techniczną obecność kompozycji oraz drogi, ale nie wykonał pomiaru kontrastu, skalowania 1x–4x ani symulacji deuteranopii/protanopii; status pozostaje UNTESTED |
