...
Pakiety: **PKG-0131 (dyrektywa), PKG-0132 (skala), PKG-0133 (chód + śluza 01), PKG-0134 (oko + one_way + 05→03)**
Status: **OTWARTA — PKG-0133 ZAMKNIĘTY**

Wykonane w PKG-0133:

1. Chód default; `sprint` (Shift / LB) jedyny bieg (D-127).
2. Stacja 01: otwarte drzwi wyłączają collider (kapsuła 72 przechodzi).
3. Interakcja: po sukcesie haczyk, bez pulsującego retikula; one-shot.

Zostaje: capture okiem, one_way 09/11, chód 05→04→03.

Zakaz `.exe` (D-125). Nazwa węzła kamery i reduced-motion czekają.

## P6-odroczone (nie otwierać przed PKG-0134)
