...
Status: **W TOKU (Zaimplementowano bazę w PKG-0012; w PKG-0013 wdrożono syntezę proceduralnego audio i cząsteczkowe sprzężenie zwrotne)**

Przewidywany zakres:

- jeden typ obiektu w dwoch wersjach rzeczywistosci (zrobione: AnchorableObject z State A / State B);
- jedno aktywne Zakotwiczenie (zrobione: zasada pojedynczej kotwicy w AnchorLab);
- trzy pokoje: nauka, zastosowanie, komplikacja (zrobione: 3 komory w AnchorLab);
- jeden prosty proces korekty reagujacy na kotwice (zrobione: fala korekty / zmiana rzeczywistosci);
- sprzężenie audiowizualne (zrobione: generator ProceduralAudio, CPUParticles2D, tlenkowy cynober fali korekty i chłodny cyjan kotwicy);
...
- scenariusz osiagnal prog H-002a wynoszący 5 (zgodnie z D-026). Przechodzimy do produkcji pokoi;
