...
## P6 — Unifikacja prezentacji i dostępność po RC1

Pakiet: **PKG-0131**
Status: **OTWARTY**

- Ujednolicenie nazwy węzła kamery (`Camera` vs `Camera2D` w stacjach 33–43) bez zmiany zachowania.
- Reduced-motion / dostępność: wyciszenie 100 Hz flickeru jarzeniówek i ograniczenie cząstek na żądanie ustawień.
- Porządek prezentacji po zamknięciu P5: bez nowych mechanik, bez nowych `.exe`.
