...
func _build_interface() -> void:
	...
	var return_line := _add_label(_title_panel, "ReturnPromise", "LINIA 4  //  OSTATNI ODCZYT  //  POWRÓT", Vector2(306.0, 181.0), Vector2(230.0, 32.0), 9, VectorStageStyle.shade(VectorStageStyle.LIGHT_PLANE, 0.12))
