...
Status: **AKTYWNY KANON WIZUALNY 2.0**  
Data: 2026-08-24  
Decyzja: ADR-006; specyfikacja renderowania:
...
Dotychczasowy rysunek z kilku brył i linii jest placeholderem technicznym.
Produkcja używa `LenaVisualRig` oddzielonego od `CharacterBody2D`, zgodnie z
...
Najbliższy pakiet wizualny to PKG-0117, Foundation Slice 01–07. Musi dostarczyć:
