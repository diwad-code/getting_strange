...
Status: **W TOKU (Otwarcie: PKG-0019, postęp: Station 01..41 wdrożone — Akt I, Akt II oraz Akt III w pełni domknięte w silniku; Akt IV: Sygnał powrotu — Scena 40 Sala Negocjacyjna oraz Scena 41 Komora Wyboru Operacyjnego z terminalami egzekucyjnymi A, B, C i mapą topografii zasięgu węzłów wdrożone w silniku)**
