...
static var _translations: Dictionary = {
	"pl": {
		...
		"TITLE_SUBTITLE": "RÓWIEŃ  //  VECTOR-STAGE  //  KANAŁ PRODUKCYJNY",
		"MENU_NEW_GAME": "NOWA GRA",
		"MENU_CONTINUE": "KONTYNUUJ",
		"MENU_REPLAY_EPILOGUE": "POWTÓRZ EPILOG",
		"MENU_SETTINGS": "USTAWIENIA",
		"MENU_QUIT": "ZAKOŃCZ",
		"STATUS_SAVE_ACTIVE": "ZAPIS: AKTYWNY\nPUNKT: %s%s",
		"STATUS_SAVE_NONE": "ZAPIS: BRAK PRAWIDŁOWEGO STANU\nNOWA GRA OTWIERA STATION 01",
		"STATUS_COMPLETED_SUFFIX": "  //  UKOŃCZONA  //  %s",
		"CONTROLS_HEADER": "STEROWANIE  //  AKCJE",
		"INPUT_ACTION_MOVE_LEFT": "RUCH LEWO",
		"INPUT_ACTION_MOVE_RIGHT": "RUCH PRAWO",
		...
		"BUILD_LABEL": "PC  //  640x360  //  FIZYKA 60 Hz",
		...
		"PAUSE_STATUS": "ODKRYTE: %d/43   |   TRYB TESTOWY: %s",
		"PAUSE_FOOTER": "PAUZA: POWRÓT  //  INTERAKCJA: WYBÓR",
		"PAUSE_STATION_TOOLTIP": "Przestrzeń %s",
	...
	"en": {
		...
		"TITLE_SUBTITLE": "RÓWIEŃ  //  VECTOR-STAGE  //  PRODUCTION CHANNEL",
		"MENU_NEW_GAME": "NEW GAME",
		"MENU_CONTINUE": "CONTINUE",
		"MENU_REPLAY_EPILOGUE": "REPLAY EPILOGUE",
		"MENU_SETTINGS": "SETTINGS",
		"MENU_QUIT": "QUIT",
		"STATUS_SAVE_ACTIVE": "SAVE: ACTIVE\nCHECKPOINT: %s%s",
		"STATUS_SAVE_NONE": "SAVE: NO VALID STATE\nNEW GAME OPENS STATION 01",
		"STATUS_COMPLETED_SUFFIX": "  //  COMPLETE  //  %s",
		"CONTROLS_HEADER": "CONTROLS  //  ACTIONS",
		...
		"BUILD_LABEL": "PC  //  640x360  //  60 Hz PHYSICS",
		...
		"PAUSE_STATUS": "DISCOVERED: %d/43   |   TEST MODE: %s",
		"PAUSE_FOOTER": "PAUSE: BACK  //  INTERACT: SELECT",
		"PAUSE_STATION_TOOLTIP": "Space %s",
