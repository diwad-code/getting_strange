# NEXT_SESSION_PROMPT — PKG-0184 / BUNDLE-34

> PKG-0183 / BUNDLE-33 jest zamknięty. Ten plik jest aktywnym handoffem:
> końcowa niezależna recertyfikacja. Nie uruchamiać równolegle z 0182/0183.
> Najpierw zweryfikuj zamknięcie PKG-0183 na dysku (CURRENT_STATE, SESSION_LOG,
> `docs/rebuild/PKG_0183_INDEPENDENT_RED_TEAM_REPORT.md`, `reports/pkg_0183/`,
> snapshot `snapshots/PKG-0183-2026-09-03/`). Nie nadpisuj `reports/pkg_0182/`
> ani `reports/pkg_0183/`.
