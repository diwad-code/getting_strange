...
# PKG-0237 (D7): domyslna galaz unseeded nie kradnie tonu C; brzmi jak
...
const DEFAULT_DIALOGUE_LINES: Array[Dictionary] = [
	...
	},
	{
		...
		"text": "Rozkład na wiacie nie zawiera adnotacji o metodzie. Żadne przejście nie zostało formalnie zatwierdzone."
	},
	{
		"speaker": "ZAPIS",
