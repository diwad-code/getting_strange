...
func _setup_guidance() -> void:
	...
	# PKG-0230 (P1-1): zdanie wyjscia — 13 → 14: przerwana proba 20:40 wyszla
	# z istniejacego materialu (15: dziennik + 11: wyciag). Rozdzielnia to
	# rozpoznanie narzedzia, nie lekcja projektanta.
	_register_beat(&"s13_exit_to_switchyard", GuidanceBeat.Tier.L3_DIRECTIONAL_THOUGHT, &"intention", &"procedural", "Próbę o 20:40 ktoś przerwał z zewnątrz. Obejrzę sprawną maszynę, zanim wejdę w cudzy ślad.", "Someone broke the 20:40 trial from outside. I study a working machine before stepping into a stranger's trace.", &"", "")
