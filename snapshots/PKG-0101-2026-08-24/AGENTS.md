...
The runtime phase is `P4: Production and polish of the Godot 4.7 game`.
All 43 campaign spaces exist as scenes. Save/campaign state, the pause menu,
the CRT dialogue surface, procedural audio and the Vector-Stage look are
**already implemented** — do not treat them as forbidden future work.
