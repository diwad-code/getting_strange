...
## pytanie Równi o odpowiedzialność zamiast komentarza o dwóch domach, epizod
## obcej pamięci przerywający zwykłą pracę Jakuba (bez nowej katastrofy).
## Dostarcza lokalny prezenter CRT (wzór CR-A/CR-B); tablica zostaje jako
