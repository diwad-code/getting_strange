...
Pakiety: **PKG-0131 (dyrektywa), PKG-0132 (wykonanie), PKG-0133 (oko + one_way + 05→03)**
Status: **OTWARTA — PKG-0132 ZAMKNIĘTY**

Wykonane w PKG-0132:

1. Lena 4.0 sprite 87 px (Gemini + Flux Kontext); kapsuła 72.
2. Próg 18 px; 0 blockerów w `geometry_audit.gd`.
3. `previous_level_requested` + `ReturnZone` na 02–43.
4. Biurka 01 do 39 px; bench 02 i rama 33 do 18 px.
