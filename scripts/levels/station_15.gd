...
func _setup_guidance() -> void:
	...
	_register_beat(&"s15_exit_to_analyzer", GuidanceBeat.Tier.L3_DIRECTIONAL_THOUGHT, &"intention", &"procedural", "Sygnał żywy, warunek przerwania znany. Niosę odpowiedź do analizatora poza obwodem.", "The signal is alive, the break condition known. I carry the reply to an analyzer off the loop.", &"", &"")
