...
func _capture() -> void:
	...
	if packed_st15:
		...
		st15_inst2.inspect_notebook()
		st15_inst2.examine_fence()
		st15_inst2.secure_phone()
		st15_inst2.start_divergence_dialogue()
		for frame in range(8):
			await process_frame
		await RenderingServer.frame_post_draw
	...
	if packed_st16:
		...
		st16_inst2.present_id_card()
		st16_inst2.scan_biometrics()
		st16_inst2.check_duty_roster()
		st16_inst2.start_clerk_dialogue()
		for frame in range(8):
			await process_frame
		await RenderingServer.frame_post_draw
	...
	if packed_st17:
		...
		st17_inst2.read_incident_report()
		st17_inst2.copy_report_header()
		st17_inst2.pull_vent_lever()
		st17_inst2.listen_intercom()
		for frame in range(8):
			await process_frame
		await RenderingServer.frame_post_draw
	...
	# 20. Station 18 (Canon 0.3 - Scene 18: Kwerenda archiwalna) captures
	...
	if packed_st18:
		...
		st18_inst2.query_municipal_deaths()
		st18_inst2.query_hospital_deaths()
		st18_inst2.query_employment_record()
		st18_inst2.start_archive_dialogue()
		for frame in range(8):
			await process_frame
		await RenderingServer.frame_post_draw
	...
	if packed_st22:
		...
		st22_inst2.start_offer_dialogue()
		st22_inst2.examine_oscilloscope()
		for frame in range(8):
			await process_frame
		await RenderingServer.frame_post_draw
	...
	# 44. Station 42A (Vertical Slice - Scene 42A: Powrót — Własny pokój)
