...
Pakiety: **PKG-0131 (dyrektywa i kanon), PKG-0132 (wykonanie)**
Status: **OTWARTA — PKG-0131 ZAMKNIĘTY**

Właściciel (2026-08-25) unieważnił cel „unifikacja kamery / reduced-motion”.
P6 odpowiada na cztery wady runtime (D-121..D-126):

1. Lena 4.0 — autorski sprite dorosłej kobiety przez `gen-ai` (Picsart).
2. Skok nie jest lokomocją; próg 18 px; drabina albo winda.
3. Dwukierunkowe lokacje: lewe wyjście emituje `previous_level_requested`.
4. Jedna skala świata (`WORLD_SCALE.md`); audyt mebli we wszystkich 43 stacjach.
5. Pełne przejście kampanii z oznaczeniem miejsc nieprzejezdnych.

Zakaz `.exe` do jawnego polecenia (D-125). Nazwa węzła kamery i reduced-motion
czekają na zamknięcie P6 playability.

## P6-odroczone (nie otwierać przed PKG-0132)
