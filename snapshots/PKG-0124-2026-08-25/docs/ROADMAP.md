...
Pakiety: **PKG-0124 (Release Candidate 1)**  
Status: **ZAKOŃCZONY (RELEASE CANDIDATE 1 OSIĄGNIĘTY DLA WINDOWS I LINUX)**
...
6. Archiwa release candidate Windows (`dist/windows/GettingStrange.exe`) i Linux (`dist/linux/GettingStrange.x86_64`).
