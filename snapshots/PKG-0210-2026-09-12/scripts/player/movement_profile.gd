...
## IMMUTABLE CONFIGURATION RESOURCE (Flyweight Pattern).
## Defines baseline locomotion profiles loaded from .tres catalogs.
## If dynamic per-scene mutation is required, set resource_local_to_scene = true.
