...
Pakiety: **PKG-0124 (Release Candidate 1), PKG-0125 (Lena 3.0, Wspinaczka, Dwukierunkowość)**  
Status: **ZAKOŃCZONE SUKCESEM (RC1 + MECHANICZNA GŁĘBIA 3.0)**
...
9. Dedykowana bramka `tests/pkg_0125_smoke_test.gd` i pełna weryfikacja `tools/verify.ps1`.
