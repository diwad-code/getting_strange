...
func _setup_guidance() -> void:
	...
	# PKG-0230 (P1-1+P1-4): zdanie wyjscia — 10 → 11 nazwane glosem Leny
	# (obok kwestii Marty "W UCP. Tam pracujesz").
	_register_beat(&"s10_exit_ucp_record", GuidanceBeat.Tier.L3_DIRECTIONAL_THOUGHT, &"intention", &"procedural", "Najpierw sprawdzę zapis pracy. W UCP, tam pracuję.", "First I check the work record. At UCP — that is where I work.", &"", "")
