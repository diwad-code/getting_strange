...
func _draw_marta_witness_station() -> void:
	...
	var marta_hair_shadow := Color("6d294f")
	var marta_hair_pink := Color("d45b9a")
	var marta_skin := Color("d39a62" if is_activated else "5e3e2b")
	draw_circle(Vector2(0.0, -22.0), 4.4, marta_hair_shadow)
	draw_rect(Rect2(-4.2, -21.0, 2.8, 12.0), marta_hair_shadow)
	draw_rect(Rect2(1.4, -21.0, 2.8, 12.0), marta_hair_shadow)
	draw_circle(Vector2(0.0, -22.0), 3.4, marta_skin)
	draw_line(Vector2(-3.7, -25.0), Vector2(2.8, -26.0), marta_hair_pink, 1.8)
	draw_line(Vector2(-3.2, -19.2), Vector2(-3.2, -9.0), marta_hair_pink, 1.3)
	draw_line(Vector2(2.8, -19.2), Vector2(2.8, -9.0), marta_hair_pink, 1.3)
	draw_arc(Vector2(0.9, -20.8), 0.9, 0.15, PI - 0.15, 5, Color("c7d3d6"), 0.7)
...
func _draw_epilogue_marta_doorstep() -> void:
	...
	# Marta silhouette in doorway: long pink hair and steel septum identify her in shadow.
	draw_rect(Rect2(-6.0, -14.0, 12.0, 38.0), Color("161c22"))
	draw_circle(Vector2(0.0, -18.0), 4.0, Color("6d294f"))
	draw_rect(Rect2(-4.0, -17.0, 2.5, 15.0), Color("6d294f"))
	draw_rect(Rect2(1.5, -17.0, 2.5, 15.0), Color("6d294f"))
	draw_circle(Vector2(0.0, -18.0), 2.9, Color("d39a62"))
	draw_line(Vector2(-3.4, -21.0), Vector2(2.7, -22.0), Color("d45b9a"), 1.8)
	draw_line(Vector2(-3.0, -15.5), Vector2(-3.0, -2.0), Color("d45b9a"), 1.3)
	draw_line(Vector2(2.6, -15.5), Vector2(2.6, -2.0), Color("d45b9a"), 1.3)
	draw_arc(Vector2(0.8, -16.8), 0.8, 0.15, PI - 0.15, 5, Color("c7d3d6"), 0.7)
	# Tool bag strap
