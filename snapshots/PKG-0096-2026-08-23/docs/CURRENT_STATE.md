...
-   Nie ma repozytorium, galezi, commita ani historii. Nie uruchamiamy `git`. Ostatni zamkniety pakiet: `PKG-0096`, 2026-08-23
...
-   ostatnie: `snapshots/PKG-0096-2026-08-23`
...
Cel: kontynuacja wyłącznie gry Godot (D-091..D-095) w następnym spójnym batchu:
1. ręcznie skonwertować Station 21..25 do Rówień Vector-Stage wraz z auditami,
   renderami i kontraktem testowym;
2. rozszerzyć limit łańcucha ukończeń do Station 25 oraz sprawdzić przejścia,
   checkpointy, unlocki i utrzymanie trybu testowego;
3. dodać CRT/checkpoint cue Aktu IIc bez zmiany colliderów lub geometrii;
4. uruchomić pełną weryfikację, udokumentować oraz zamrozić `PKG-0097`.
...
plik i `NEXT_SESSION_PROMPT.md`, a następnie przechodzi do realizacji PKG-0097 w silniku Godot 4.7.
