...
func _test_bundle_13_station_07_building_exterior() -> void:
	...
	# PKG-0193 / CR-D04: the contradiction concerns flats in the same building.
	_expect(facade_text != null and facade_text.text.contains("SADOWA 7"), "Facade plaque must identify building Sadowa 7")
	_expect(cert_text != null and cert_text.text.contains("SADOWA 7 M. 12"), "Certificate must identify flat 12 in the same building")
	_expect(intercom_text != null and intercom_text.text.contains("12: KOWALCZYK") and intercom_text.text.contains("14: WOLSKA / KUREK"), "Independent directory must assign flat 12 to Kowalczyk and 14 to Wolska / Kurek")
