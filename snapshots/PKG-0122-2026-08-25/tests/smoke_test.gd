...
func _test_station_03() -> void:
	...
	# Initial state: no message opened, door sealed, level not complete
...
func _test_station_05() -> void:
	...
	_expect(station.is_level_completed, "station_05 must complete on entering airlock zone")
...
func _test_station_08() -> void:
	...
	_expect(station.get_node_or_null("AirlockZone") != null, "station_08: airlock_zone missing")
...
func _test_station_09() -> void:
	...
	_expect(station.get_node_or_null("AirlockZone") != null, "station_09: airlock_zone missing")
...
func _test_station_10() -> void:
	...
	_expect(station.get_node_or_null("AirlockZone") != null, "station_10: airlock_zone missing")
...
func _test_station_11() -> void:
	...
	_expect(station.get_node_or_null("AirlockZone") != null, "station_11: airlock_zone missing")
...
func _test_station_12() -> void:
	...
	_expect(station.get_node_or_null("AirlockZone") != null, "station_12: airlock_zone missing")
...
func _test_station_13() -> void:
	...
	_expect(station.get_node_or_null("AirlockZone") != null, "station_13: airlock_zone missing")
...
func _test_station_22() -> void:
	...
	_expect(station.is_offer_completed, "station 22: offer rejected")

	station.examine_oscilloscope()
	_expect(station.is_oscilloscope_checked, "station 22: oscilloscope examined")
	_expect(station.are_modes_named, "station 22: anchor and yield named")
...
func _test_station_23() -> void:
	...
	_expect(station.is_cost_understood, "station 23: mechanic cost understood")
