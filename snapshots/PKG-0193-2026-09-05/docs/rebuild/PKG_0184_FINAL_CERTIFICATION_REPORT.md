...
Snapshot (frozen copy, not workspace): `snapshots/PKG-0184-2026-09-04/`. The tool copied `scenes/`, `scripts/`, `tests/`; this report, live docs and log/tsv evidence were extra-frozen beside them. Do not read the snapshot as current state.
