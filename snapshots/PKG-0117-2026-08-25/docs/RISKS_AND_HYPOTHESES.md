...
|---|---|---|---|---|
| H-001 | Responsywność ruchu da się pogodzić z ciężarem nowej animacji Leny | MIERZALNA + ODBIORCZA | UNTESTED | zastany rig ma smoke techniczny; test timingów i nowa inspekcja w PKG-0118; przyjemność ruchu bez dowodu |
| H-002 | Anchor/Yield ma dość znaczących zastosowań, by unieść drugą tajemnicę 22–41 | MIERZALNA + ODBIORCZA | UNTESTED | audyt czynność–koszt–konsekwencja po PKG-0122; historyczne 5/43 dotyczyło innego kanonu |
| H-003 | Narastanie 01–20 buduje niepokój bez zdradzenia rozwiązania i bez nudy | ODBIORCZA | ACCEPTED-RISK | mierzalne proxy: sufity wiedzy, lint terminów i rozkład dowodów; emocja i nuda bez dowodu |
| H-004 | Obraz i dźwięk wskazują zdarzenie przed myślą Leny | MIERZALNA + ODBIORCZA | UNTESTED | audyt kolejności show → reaction → thought i capture; zrozumienie bez dowodu |
| H-005 | Pixel-Stage jest wydajny i powtarzalny w 43 scenach | KOSZTOWA | UNTESTED | zastany komponent ma smoke API; profil kompozytora od PKG-0118; stare metryki Vector-Stage nie są budżetem nowej warstwy |
| H-006 | Omylne interpretacje Leny brzmią ludzko, nie jak arbitralne oszustwo | ODBIORCZA | ACCEPTED-RISK | audyt: obserwacja prawdziwa, hipoteza uzasadniona, cel mechaniczny prawdziwy; odbiór bez dowodu |
| H-007 | Lena pozostaje czytelną osobą w `640x360` po próbkowaniu świata do `320x180` | MIERZALNA + ODBIORCZA | UNTESTED | sylwetka, stawy, kontrast i klatki 1x–4x; rozpoznawalność emocji bez dowodu |
| H-008 | Marta, Jakub, miejscowa Lena i Wierzbicka zachowują własne cele przez 2,5–3,5 godziny | MIERZALNA + ODBIORCZA | UNTESTED | audyt celów, odmów, decyzji i konsekwencji; emocjonalna waga bez dowodu |
| H-009 | Wierzbicka i UCP są skuteczną, racjonalną opozycją, a nie jednowymiarowym złem | ODBIORCZA | OPEN-NO-EVIDENCE | policzyć sceny korzyści, szkody, decyzji i ustępstw po migracji 14–38 |
| H-010 | Rozpoznanie w Station 21 jest uczciwe i nieprzedwczesne | MIERZALNA + ODBIORCZA | UNTESTED | trzy niezależne rodziny dowodów i lint wiedzy; zaskoczenie pozostaje bez dowodu |
...
| H-012 | Wszystkie czytelne teksty pozostają ostre nad pikselizowanym światem | MIERZALNA | UNTESTED | test warstw, normal-driver capture, skale 1x–4x i tekst 85–115% |
| H-013 | System myśli pomaga przy zastoju bez spamowania | MIERZALNA + ODBIORCZA | UNTESTED | progi, cooldown ≥8 s, brak powtórek, reset po postępie; pomocność bez dowodu |
| H-014 | Dwie różne relacje Marty z dwiema Lenami są zrozumiałe bez wykładu | MIERZALNA + ODBIORCZA | UNTESTED | tracker relacji, rozkład konkretnych wspomnień i zakaz synonimicznego dialogu; zrozumienie bez dowodu |
| H-015 | Miejscowa Lena pozostaje sprawczą osobą mimo fizycznej nieobecności | MIERZALNA + ODBIORCZA | UNTESTED | policzyć jej intencjonalne decyzje, warunki przerwania i zmiany planu innych; poczucie obecności bez dowodu |
| H-016 | Druga tajemnica po Station 21 utrzymuje napięcie zamiast zamienić się w procedurę | ODBIORCZA | ACCEPTED-RISK | audyt pytań, zwrotów i zmiany stawki 22–38; napięcie bez dowodu |
