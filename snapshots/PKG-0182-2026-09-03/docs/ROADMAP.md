...
| DEF-2 | portret Marty to przemalowany portret Leny | GATE-CAST |
| DEF-3 | NPC to kółka i trapezy 22–48 px zamiast sprite'ów 84–92 px | GATE-CAST |
...
| DEF-9 | *(znalezisko sesji)* obsady nie ma na trasie: jedyna osoba to sylwetka Marty w 42B/C | GATE-CAST, po decyzji właściciela A/B/C |
...
| PKG-0183 | BUNDLE-33 | Niezależny red-team audyt i naprawy po PKG-0182 | **OTWARTY — NASTĘPNY PAKIET** |
| PKG-0184 | BUNDLE-34 | Finalna niezależna recertyfikacja | **ZAPLANOWANY — po zamknięciu PKG-0183** |
