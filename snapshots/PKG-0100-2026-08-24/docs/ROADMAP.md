...
Audyt PKG-0100 wykazał, że **38 z 43 przestrzeni ma dokładnie cztery collidery**
— podłogę, sufit i dwie ściany. Gracz wchodzi z lewej, idzie w prawo, dotyka
rekwizytów i wychodzi. Zakotwiczenie jest już użyte w kampanii w Station 09,
12 i 14, a pięć kolejnych przeszkód diegetycznych działa w Station 06..10.
...
- **Dług znany:** Station 16..20 nadal wymagają przeniesienia na widoczną
  warstwę stanu Vector-Stage i osobnego audytu; Station 01..15 mają ten etap
  zamknięty w PKG-0100/PKG-0099 (D-096).
